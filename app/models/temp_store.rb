##
# Interface to the bucket in which temporary files are stored. Wraps an
# {Aws::S3::Client}, adding some convenience methods and forwarding all other
# method calls to it.
#
...
class TempStore
  ...
  def self.client_options
    ...
    access_key_id     = config.storage.dig(:temp, :access_key_id)
    secret_access_key = config.storage.dig(:temp, :secret_access_key)
